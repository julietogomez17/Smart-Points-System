...
npm run dev
cd smart-points-backend

cd smart-points-frontend
npm start
...
Monthly Benefitsfortesting

UPDATE user_rank_profiles
SET current_rank = 'Bronze'
WHERE user_id = 9;


Then make sure that user has approved activity this month:
...
SET reviewed_at = '2026-04-30 23:59:00'
WHERE user_id = 9
  AND status = 'approved';
